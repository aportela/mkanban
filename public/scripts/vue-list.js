                    ...
                    <div v-if="showAddCardForm" class="card-content">
                        <div class="field">
                            <div class="control" v-bind:class="{ 'is-loading': isAddingNewCard, 'has-icons-right': addError }">
                                <input v-bind:disabled="isAddingNewCard" v-on:keyup.enter="saveNewCard();" v-on:keyup.escape="cancelNewCard();" ref="cardTitle" class="input" rows="2" type="text" placeholder="type card title" v-model="newCardTitle">
